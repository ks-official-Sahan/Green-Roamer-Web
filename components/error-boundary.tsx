          ...
          >
            <Card className="w-full max-w-lg mx-auto glass-effect">
              <CardHeader className="text-center">
                ...
                {this.state.errorId && (
                  <div className="mt-2 text-xs text-muted-foreground">Error ID: {this.state.errorId}</div>
                )}
              </CardHeader>
                      ...
                      <div className="text-xs bg-muted/50 rounded-lg p-3 space-y-2">
                        {this.state.error && (
                          <div>
                            ...
                            <div className="font-mono text-muted-foreground break-all">{this.state.error.message}</div>
                          </div>
                        )}
                        ...
                        {this.state.errorInfo?.componentStack && (
                          <div>
                            <div className="font-medium text-destructive">Component Stack:</div>
                            <div className="font-mono text-muted-foreground text-xs break-all max-h-32 overflow-y-auto">
                              {this.state.errorInfo.componentStack}
                            </div>
                          </div>
